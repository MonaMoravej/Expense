    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            var model = new IndexViewModel
            {
                ...
                PhoneNumber = await UserManager.GetPhoneNumberAsync(Guid.Parse(userId)),
                TwoFactor = await UserManager.GetTwoFactorEnabledAsync(Guid.Parse(userId)),
                Logins = await UserManager.GetLoginsAsync(Guid.Parse(userId)),
